					...
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white" href="/tel:123-456-7890">
								...
								<span className="d-none d-lg-inline-block">+60 12-345-67-89</span>
							</Link>
				...
				<div className="container-fluid background-body">
					<div className="main-header">
						<div className="header-left">
							<div className="header-logo" style={{ marginLeft: '50px' }}>
								<Link className="d-flex" href="/">
									<img className="light-mode" alt="Lycafleet" src="/assets/imgs/logo/logo.png" width="140" height="55" />
									<img className="dark-mode" alt="Lycafleet" src="/assets/imgs/logo/logo.png" width="140" height="55" />
								</Link>
							</div>
									...
									<ul className="main-menu">
										...
										<li className="has-children">
											...
											<ul className="sub-menu">
												<li><Link href="/services">Singapore To Malaysia</Link></li>
												<li><Link href="/services-1">Malaysia To Singapore</Link></li>
											</ul>
										</li>
										<li><Link href="/vehicle-gallery">Vehicle Gallery</Link></li>
							...
							<div className="header-right">
								<Link
									className="text-white px-4 py-3 text-sm font-semibold mr-3 d-flex align-items-center rounded-pill border-0 d-none d-lg-inline"
									href="/reserve-via-whatsapp"
									style={{
									...
									onMouseEnter={(e) => {
										...
										target.style.background = 'linear-gradient(135deg, #00E676 0%, #25D366 50%, #128C7E 100%)';
										target.style.boxShadow = '0 8px 25px rgba(0, 230, 118, 0.4), 0 0 20px rgba(37, 211, 102, 0.2)';
								...
								<div className="burger-icon burger-icon-white" onClick={handleMobileMenu} style={{ marginTop: '-25px' }}>
