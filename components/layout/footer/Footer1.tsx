				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-md-2 col-xs-6 footer-3">
							<h6 className="text-linear-3">Quick Link</h6>
						...
						<div className="col-md-2 col-xs-6 footer-4">
							<h6 className="text-linear-3">Reservations & Inquiries</h6>
							<ul className="menu-footer">
								<li><Link href="/reserve-via-whatsapp">Reserve via Whatsapp</Link></li>
							</ul>
						</div>
					...
					<div className="footer-bottom mt-50">
						<div className="row align-items-center justify-content-center">
							<div className="col-md-6 text-md-start text-center mb-20">
								<p className="text-sm color-white">©2025 {/* {new Date().getFullYear()} */} Lycafleet. All rights reserved.</p>
							</div>
