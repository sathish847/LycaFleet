								...
								<SwiperSlide>
									<div className="item-banner-slide banner-1">
										<div className="container">
											...
											<h1 className="mt-20 mb-20 color-white">Seamless Cross-Border Travel</h1>
											...
											<span className="text-lg-medium color-white d-lg-none">Book via <Link className="text-primary" href="/reserve-via-whatsapp">WhatsApp</Link> for instant confirmation</span>
										</div>
									</div>
								</SwiperSlide>
								<SwiperSlide>
									<div className="item-banner-slide banner-2">
										<div className="container">
											...
											<h1 className="mt-20 mb-20 color-white">Luxury Private Transfers</h1>
