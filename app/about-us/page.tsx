					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/about/1.jpg" alt="Carento" />
							</div>
							...
							<div className="row pb-50">
								<div className="col-lg-4">
									<h3 className="neutral-1000">
										...
										<span className="text-primary">LycaFleet</span>
										Excellence
									</h3>
...
LycaFleet is a fully MOTAC-registered premier private transportation and tour service provider, specializing in seamless and luxurious cross-border travel between Singapore and Malaysia. We provide comfortable door-to-door private taxi services to every popular destination including Johor Bahru, Legoland Malaysia, Desaru, Johor Premium Outlets (JPO), Kukup, Pontian, Kluang, Batu Pahat, Muar, Mersing Jetty & Tioman Island, Malacca, Kuala Lumpur, Port Dickson, Genting Highlands, Cameron Highlands, Ipoh and Penang. Whether you’re travelling one-way or return, we make every journey effortless and VIP-worthy.
</p>

<p className="text-lg-medium neutral-500 mt-3">
Enjoy complete peace of mind with our meticulously maintained modern fleet — including the comfortable Toyota Innova, spacious Hyundai Starex/Staria, and luxurious Toyota Alphard/Vellfire — each vehicle thoroughly cleaned and disinfected before every trip. Popular routes booked daily with us include Singapore To Johor Bahru, Singapore To Legoland, Singapore To Desaru, Singapore To Tioman Island (via Mersing Jetty), Singapore To Malacca, Singapore To Kuala Lumpur, Senai Airport To Singapore, Mersing/Mersing Jetty To Singapore, and even Tioman Island ferry pickup straight back to Singapore. We offer free comprehensive travel insurance, transparent fixed pricing with no hidden fees, and 24/7 dedicated customer support. Choose LycaFleet for reliable, safe, sanitized, and luxurious private transport that transforms every trip into pure convenience and delight.
</p>
								</div>
							</div>
							<div className="row g-4">
								<div className="col-lg-4 col-md-6">
									<div className="box-image rounded-12 position-relative overflow-hidden">
										<img className="rounded-12" src="/assets/imgs/about/108099_imresizer.jpg" alt="Carento" />
								...
								<div className="col-lg-4 col-md-6">
									<div className="box-image rounded-12 position-relative overflow-hidden">
										<img className="rounded-12" src="/assets/imgs/about/2149106167.jpg" alt="Carento" />
									</div>
								</div>
								<div className="col-lg-4 col-12">
									<div className="d-flex flex-column gap-4 align-self-stretch h-100">
										...
										<img className="rounded-12" src="/assets/imgs/about/2149204545.jpg" alt="Carento" />
									</div>
								</div>
							</div>
						</div>
								...
								<div className="col-lg-3 col-sm-6">
									<div className="card-why text-start wow fadeInUp">
										...
										<div className="card-info">
											<h6 className="text-xl-bold neutral-1000 text-start">Seamless Cross-Border Travel</h6>
											<p className="text-md-medium neutral-500">Effortless cross-border travel between Singapore and Malaysia.</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-sm-6">
									<div className="card-why text-start wow fadeInUp">
										...
										<div className="card-info">
											<h6 className="text-xl-bold neutral-1000 text-start">Fixed Transparent Pricing</h6>
											<p className="text-md-medium neutral-500">Transparent pricing with no hidden fees.</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-sm-6">
									<div className="card-why text-start wow fadeInUp">
										...
										<div className="card-info">
											<h6 className="text-xl-bold neutral-1000 text-start">Door-to-Door Convenience</h6>
											<p className="text-md-medium neutral-500">Convenient pickups and drop-offs at any location.</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-sm-6">
									<div className="card-why text-start wow fadeInUp">
										...
										<div className="card-info">
											...
											<p className="text-md-medium neutral-500">Dedicated 24/7 customer support available.</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="container">
								<div className="row align-items-center">
									<div className="col-lg-5">
										...
										<h4 className="mb-4 neutral-1000">Experience premium private transport. <br />Book with LycaFleet today.</h4>
										<p className="text-lg-medium neutral-500 mb-4">Our mission is to provide seamless and luxurious cross-border transportation between Singapore and Malaysia, ensuring every journey is safe, comfortable, and stress-free. We are committed to delivering exceptional service with professional drivers, modern vehicles, and 24/7 support.</p>
										<div className="row">
											<div className="col">
												<ul className="list-ticks-green list-ticks-green-2">
													<li className="neutral-1000 pe-0">Seamless cross-border transfers with no queues</li>
													<li className="neutral-1000 pe-0">Professional drivers and modern fleet for comfort</li>
													<li className="neutral-1000 pe-0">24/7 customer support and transparent pricing</li>
												</ul>
											</div>
										</div>
										<Link className="btn btn-primary mt-2" href="/reserve-via-whatsapp">
										...
										<div className="d-flex flex-column gap-4">
											<div className="d-flex gap-4">
												<div className="position-relative">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/1.jpg" alt="Carento" />
												</div>
												<div className="mt-auto">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/2.jpg" alt="Carento" />
												</div>
											</div>
											<div className="d-flex gap-4">
												<div className="position-relative">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/3.jpg" alt="Carento" />
												</div>
												<div className="position-relative">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/4.jpg" alt="Carento" />
												</div>
											</div>
										</div>
									</div>
										...
										<div className="d-flex align-items-center justify-content-around flex-wrap">
											<div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
												<div className="d-flex justify-content-center justify-content-md-start">
													<h3 className="count neutral-1000"><CounterUp count={86} /></h3>
													<h3 className="neutral-1000">+</h3>
												</div>
												<div className="text-md-start text-center">
													<p className="text-lg-bold neutral-1000">Professional</p>
													<p className="text-lg-bold neutral-1000">Drivers</p>
												</div>
											</div>
											<div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
												<div className="d-flex justify-content-center justify-content-md-start">
													<h3 className="count neutral-1000"><CounterUp count={25} /></h3>
													<h3 className="neutral-1000">+</h3>
												</div>
												<div className="text-md-start text-center">
													<p className="text-lg-bold neutral-1000">Years in</p>
													<p className="text-lg-bold neutral-1000">Business</p>
												</div>
											</div>
											<div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
												<div className="d-flex justify-content-center justify-content-md-start">
												...
												<div className="text-md-start text-center">
													<p className="text-lg-bold neutral-1000">Modern</p>
											...
											<div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
												...
												<div className="text-md-start text-center">
													<p className="text-lg-bold neutral-1000">Satisfied</p>
													<p className="text-lg-bold neutral-1000">Passengers</p>
												</div>
											</div>
											<div className="mb-4 mb-lg-0 d-block px-lg-5 px-3">
												<div className="d-flex justify-content-center justify-content-md-start">
													<h3 className="count neutral-1000"><CounterUp count={24} /></h3>
													<h3 className="neutral-1000">/7</h3>
												</div>
												<div className="text-md-start text-center">
													<p className="text-lg-bold neutral-1000">Customer</p>
													<p className="text-lg-bold neutral-1000">Support</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div className="row align-items-center">
									<div className="col-lg-6">
										<div className="card-image d-inline-block position-relative mb-100">
											<img className="rounded-12" src="/assets/imgs/cta/cta-9/1.jpg" alt="Carento" />
											{/* <a className="btn btn-play popup-youtube position-absolute top-50 start-50 translate-middle" onClick={() => setOpen(true)} /> */}
											<img className="position-absolute top-100 start-100 translate-middle rounded-12 d-none d-md-block" src="/assets/imgs/cta/cta-9/2.jpg" alt="Carento" />
										</div>
									</div>
									<div className="col-lg-6 ps-lg-5">
										<Link className="btn btn-signin bg-2 text-dark mb-4" href="#">Our Commitment</Link>
										<h4 className="mb-4 neutral-1000">LycaFleet delivers seamless cross-border travel with excellence.</h4>
										<p className="text-lg-medium neutral-500 mb-4">We are committed to providing seamless cross-border transportation between Singapore and Malaysia with professional drivers, modern vehicles, and exceptional service. At LycaFleet, your safety, comfort, and satisfaction are our top priorities.</p>
										<div className="row">
											<div className="col">
												<ul className="list-ticks-green list-ticks-green-2">
													<li className="neutral-1000 pe-0">Seamless cross-border transfers with no queues</li>
											...
											<div className="swiper-wrapper">
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														<div className="card-info">
															<p className="text-xl-bold card-title neutral-1000">Seamless Cross-Border Travel</p>
															<p className="text-md-regular neutral-500">LycaFleet made our trip from Singapore to Johor Bahru effortless. No queues at customs, professional driver, and we arrived exactly on time. Highly recommended!</p>
														</div>
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																...
																<div className="card-info">
																	<p className="text-lg-bold neutral-1000">Sarah Chen</p>
																	<p className="text-md-regular neutral-1000">Singapore</p>
																</div>
															</div>
												...
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														<div className="card-info">
															<p className="text-xl-bold card-title neutral-1000">Professional & Reliable Service</p>
															<p className="text-md-regular neutral-500">The Toyota Alphard was spotless and comfortable. Our driver was punctual, friendly, and handled the border crossing smoothly. Will definitely use LycaFleet again!</p>
														</div>
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-2.png" alt="Carento" /></div>
																<div className="card-info">
																	<p className="text-lg-bold neutral-1000">Ahmad Rahman</p>
																	<p className="text-md-regular neutral-1000">Kuala Lumpur</p>
																</div>
															</div>
															<div className="card-rate"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /></div>
														</div>
												...
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														<div className="card-info">
															<p className="text-xl-bold card-title neutral-1000">24/7 Customer Support</p>
															<p className="text-md-regular neutral-500">Needed to change our pickup time last minute and LycaFleet's customer support was available immediately. They handled everything professionally and efficiently.</p>
														</div>
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-3.png" alt="Carento" /></div>
																<div className="card-info">
																	<p className="text-lg-bold neutral-1000">Maria Santos</p>
																	<p className="text-md-regular neutral-1000">Manila</p>
																</div>
															</div>
															<div className="card-rate"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /></div>
														</div>
												...
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														<div className="card-info">
															<p className="text-xl-bold card-title neutral-1000">Transparent Pricing</p>
															<p className="text-md-regular neutral-500">No hidden fees, exactly as quoted. The Hyundai Starex was perfect for our family trip to Genting Highlands. Clean, comfortable, and great value for money.</p>
														</div>
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-1.png" alt="Carento" /></div>
																<div className="card-info">
																	<p className="text-lg-bold neutral-1000">David Wong</p>
																	<p className="text-md-regular neutral-1000">Penang</p>
																</div>
															</div>
															<div className="card-rate"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="Carento" /></div>
														</div>
										...
										<div className="accordion-item wow fadeInUp border-bottom-0">
											<h5 className="accordion-header" id="headingOne" onClick={() => handleAccordion(1)}>
												<button className={`accordion-button text-heading-5 ${isAccordion === 1 ? 'collapsed' : ''}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
													<h3>01</h3>
													<p>How do I book a LycaFleet transfer?</p>
												</button>
											</h5>
											<div className={`accordion-collapse collapse ${isAccordion == 1 ? 'show' : ''} `} id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionFAQ">
												<div className="accordion-body">Booking with LycaFleet is simple! Contact us via WhatsApp, email, or our website. Provide your pickup location, destination, date, time, and passenger details. We'll confirm your booking within 30 minutes and send you a confirmation with all details including vehicle type and driver information.</div>
											</div>
										</div>
										<div className="accordion-item wow fadeInUp border-bottom-0">
											<h5 className="accordion-header" id="headingTwo" onClick={() => handleAccordion(2)}>
												<button className={`accordion-button text-heading-5 ${isAccordion === 2 ? 'collapsed' : ''}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
													<h3>02</h3>
													<p>What documents do I need for cross-border travel?</p>
												</button>
											</h5>
											<div className={`accordion-collapse collapse ${isAccordion == 2 ? 'show' : ''} `} id="collapseTwo" aria-labelledby="headingTwo" data-bs-parent="#accordionFAQ">
												<div className="accordion-body">For Singapore to Malaysia travel, you'll need a valid passport or identification card. Singapore citizens and permanent residents can use their NRIC. Foreign visitors need their passport. No visa is required for short visits. Our drivers will guide you through the border process and handle any necessary documentation assistance.</div>
											</div>
										</div>
										<div className="accordion-item wow fadeInUp border-bottom-0">
											<h5 className="accordion-header" id="headingThree" onClick={() => handleAccordion(3)}>
												<button className={`accordion-button text-heading-5 ${isAccordion === 3 ? 'collapsed' : ''}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
													<h3>03</h3>
													<p>What are your cancellation and modification policies?</p>
												</button>
											</h5>
											<div className={`accordion-collapse collapse ${isAccordion == 3 ? 'show' : ''} `} id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordionFAQ">
												<div className="accordion-body">We offer flexible cancellation up to 24 hours before your scheduled pickup with full refund. Changes to booking details (time, location, passenger count) can be made up to 12 hours in advance. For last-minute changes within 12 hours, we'll do our best to accommodate but cannot guarantee availability. Contact us immediately if you need to modify your booking.</div>
											</div>
										</div>
										<div className="accordion-item wow fadeInUp border-bottom-0">
											<h5 className="accordion-header" id="headingFour" onClick={() => handleAccordion(4)}>
												<button className={`accordion-button text-heading-5 ${isAccordion === 4 ? 'collapsed' : ''}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
													<h3>04</h3>
													<p>What types of vehicles do you offer?</p>
												</button>
											</h5>
											<div className={`accordion-collapse collapse ${isAccordion == 4 ? 'show' : ''} `} id="collapseFour" aria-labelledby="headingFour" data-bs-parent="#accordionFAQ">
												<div className="accordion-body">We offer a range of modern, well-maintained vehicles: Toyota Innova (comfortable for 4-5 passengers), Hyundai Starex/Staria (spacious for 7-9 passengers), and Toyota Alphard/Vellfire (luxury option for VIP transfers). All vehicles are fully air-conditioned, sanitized before each trip, and equipped with GPS tracking and complimentary water.</div>
											</div>
										</div>
										<div className="accordion-item wow fadeInUp border-bottom-0">
											<h5 className="accordion-header" id="headingFive" onClick={() => handleAccordion(5)}>
												<button className={`accordion-button text-heading-5 ${isAccordion === 5 ? 'collapsed' : ''}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
													<h3>05</h3>
													<p>How long does the border crossing take?</p>
												</button>
											</h5>
											<div className={`accordion-collapse collapse ${isAccordion == 5 ? 'show' : ''} `} id="collapseFive" aria-labelledby="headingFive" data-bs-parent="#accordionFAQ">
												<div className="accordion-body">Border crossing time varies depending on traffic and peak hours. Typically, it takes 30-60 minutes for Singapore to Johor Bahru. Our experienced drivers know the fastest routes and will guide you through the process efficiently. We always add buffer time to ensure you arrive at your destination on schedule.</div>
											</div>
										</div>
									</div>
								</div>
